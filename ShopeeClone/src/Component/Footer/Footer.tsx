    ...
    <footer className='py-20 bg-slate-100'>
      <div className='container w-1/2 '>
        <div className='flex flex-row justify-between'>
          ...
          <div className='p-4'>
            <div className='font-bold'>VẾ SHOPEE</div>
          ...
          <div className='p-4'>
            ...
            <ul className='mt-2 flex justify-between'>
              <div className='p-2'>
                <li className='p-3 bg-slate-200 shadow-md'>
                  <a>
                    <img
                ...
                <li className=' mt-3   bg-slate-200 shadow-md p-3'>
                  <a>
                    <img
              ...
              <div className='p-2'>
                ...
                <li className='p-3 mt-3   bg-slate-200 shadow-md '>
                  <a>
                    <img
